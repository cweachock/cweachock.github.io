...
Currently, I am doing freelance web development with a focus on [@shopify](https://www.shopify.com/?ref=chris-weachock-design){:target="_blank"} and learning more about ecommerce. Previously, I worked for [@mcuban](https://twitter.com/mcuban){:target="_blank"} at [Mark Cuban Companies](http://markcubancompanies.com/){:target="_blank"} with a small team onboarding companies from the hit reality show [Shark Tank ](http://abc.go.com/shows/shark-tank){:target="_blank"} on [ABC](http://abc.go.com/){:target="_blank"}. 
